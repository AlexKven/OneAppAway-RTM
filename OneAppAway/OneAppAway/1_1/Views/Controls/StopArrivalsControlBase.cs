...
namespace OneAppAway._1_1.Views.Controls
{
    public class StopArrivalsControlBase : UserControl
    {
        ...
        public static readonly DependencyProperty TopControlsVisibilityProperty =
            DependencyProperty.Register("TopControlsVisibility", typeof(Visibility), typeof(StopArrivalsControlBase), new PropertyMetadata(Visibility.Collapsed));
        ...
        public static readonly DependencyProperty ExpandCommandProperty =
            DependencyProperty.Register("ExpandCommand", typeof(ICommand), typeof(StopArrivalsControlBase), new PropertyMetadata(null));
        ...
        public static readonly DependencyProperty CompressCommandProperty =
            DependencyProperty.Register("CompressCommand", typeof(ICommand), typeof(StopArrivalsControlBase), new PropertyMetadata(null));
        ...
        public static readonly DependencyProperty CloseCommandProperty =
            DependencyProperty.Register("CloseCommand", typeof(ICommand), typeof(StopArrivalsControlBase), new PropertyMetadata(null));
        ...
        public static readonly DependencyProperty TitleCommandProperty =
            DependencyProperty.Register("TitleCommand", typeof(ICommand), typeof(StopArrivalsControlBase), new PropertyMetadata(null));
    }
}
