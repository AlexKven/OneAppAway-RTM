...
{
    //From here:
    //http://stackoverflow.com/questions/3852268/c-sharp-implementation-of-googles-encoded-polyline-algorithm
    public static class GooglePolylineConverter
    {
        ...
        public static IEnumerable<LatLon> Decode(string polylineString)
        {
            ...
            while (index < polylineChars.Length)
            {
                ...
                yield return new Data.LatLon(Convert.ToDouble(currentLat) / 1E5, Convert.ToDouble(currentLng) / 1E5);
            }
        }
        ...
        public static string Encode(IEnumerable<LatLon> locations)
        {
